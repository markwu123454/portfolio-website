...
const detailByKey: Record<string, JSX.Element> = {
    ...
    git: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                ...
                Git(Github) is used in all my projects.
            </p>
        </div>
    ),
    sklearn: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                ...
                SKLearn is used in the Scouting App.
            </p>
        </div>
    ),
    postgresql: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                ...
                PostGre is used in the Scouting App and The Gradebook.
            </p>
        </div>
    ),
    next: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                A typescript framework that incorporate frontend and backend that I used for this website. Next.js(and
                vercel) is used in The GradeBook and this website.
            </p>
        </div>
    ),
    typescript: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                A popular programming language that is commonly used in web development. TS is used in The GradeBook,
                this website, Aetherius GCS, and the Scouting App.
            </p>
        </div>
    ),
    react: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                A typescript framework I used in multiple other projects. React is used in The GradeBook, this website,
                Aetherius GCS, and the Scouting App.
            </p>
        </div>
    ),
    tailwind: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                A useful css replacement tool I use on all my web projects to improve ui and presentation. TailWind is
                used in The GradeBook, this website, Aetherius GCS, and the Scouting App.
            </p>
        </div>
    ),
    python: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                ...
                other programs. Python is used in Aetherius GCS and the Scouting App.
            </p>
        </div>
    ),
    fastapi: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                A Python backend library I commonly use with React. Fastapi(and uvicorn) is used in Aetherius GCS and
                the Scouting App.
            </p>
        </div>
    ),
    solidworks: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                A cading software I use in Team Sprocket for designing complex subsystems and robot assemblies. SolidWorks is used in Team Sprocket and SigmaCat Robotics.
            </p>
        </div>
    ),
    fusion360: (
    ...
    raspberrypi: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                A mini-computer or microcontroller I used in Dronescape and various other projects. Raspberry pi is used in Aetherius UAV
            </p>
        </div>
    ),
    bambulab: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                A 3D printer brand which I utilised a lot in various projects. BambuLab (specifically A1 & X1C, and studio) is used in Team Sprocket, Aetherius UAV, and Team Infernope.
            </p>
        </div>
    ),
    mavlink: (
        <div className="p-5">
            ...
            <p className="mt-1 text-sm text-white/80">
                A communication protocol used in my Dronescape project, where I specifically used PyMavLink. Mavlink(and PixHawk and ArduPilot) is used in Aetherius UAV & GCS.
            </p>
        </div>
    ),
};
...
const defaultCard = (
    <div className="p-5">
        ...
        <p className="mt-1 text-sm text-white/80">These are the libraries and tools I have used in past projects.</p>
    </div>
);
...
export default function HomePage() {
    ...
    return (
        <div className="flex flex-col justify-start min-h-screen pt-10 space-y-8 bg-gradient-to-b text-white">
            <JsonLd id="person-jsonld" data={person} />

            {/* Hero Section */}
            <section className="pt-24 max-w-5xl px-10">
                <h1 className="text-5xl font-extrabold tracking-tight">Hi! I&#39;m Mark.</h1>
                <p className="mt-4 text-lg text-gray-300">
                    This website is a showcase of my teams and projects. Explore my work in software development, and robotics.
                </p>
            </section>
            ...
            <section className="max-w-6xl px-10">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    <div className="rounded-lg bg-zinc-900/80 border border-white/10 p-4 hover:bg-zinc-800 transition-colors">
                        <h3 className="text-xl font-semibold">Aetherius UAV</h3>
                        <p className="mt-2 text-gray-400">
                            A twin bloom drone for long duration mission, mainly terrain mapping, using a onboard raspberry pi to
                            communicate to a custom ground control station.
                        </p>
                    ...
                    <div className="rounded-lg bg-zinc-900/80 border border-white/10 p-4 hover:bg-zinc-800 transition-colors">
                        ...
                        <p className="mt-2 text-gray-400">
                            A scouting app for FRC that I developed, which use a react frontend and python FastAPI backend, it
                            features live sync over HTTPS, live AI powered data analytics, and full offline scouting.
                        </p>
            ...
            {/* Logos + Details */}
            <section
                className="select-none py-10 border-b border-white/10"
            ...
            >
                <div className="marquee overflow-x-hidden">
                    ...
                    >
                        {useMemo(() => [...LOGOS, ...LOGOS, ...LOGOS, ...LOGOS], []).map((src, i) => {
                            const k = keyFromPath(src);
                            return (
                                <div
                                    key={`${k}-${i}`}
                                    className="px-10 flex items-center justify-center flex-none min-h-28 logo-tile"
                                >
                                    <button
            ...
            <section className="max-w-4xl space-y-3 px-10">
                ...
                <p className="text-gray-300">
                    Interested in collaborating or learning more about my work? Reach out via the contact form.
                </p>
                <div className="flex gap-4">
                    <a
                        ...
                        className="inline-flex items-center gap-2 rounded-xl px-4 py-2 text-white border border-white/20 bg-black/40 backdrop-blur hover:bg-white/20 transition focus:outline-none focus:ring-2 focus:ring-white/30"
                    >
                        <img src="/gmail.png" alt="Gmail" className="scale-120" width={20} height={20} />
